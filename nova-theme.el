...
(nova-set-faces
  ...
  (ivy-minibuffer-match-face-2 :background orange :foreground bg)
  (ivy-minibuffer-match-face-3 :background pink :foreground bg)
  (ivy-minibuffer-match-face-4 :background green :foreground bg)

  ;; swiper faces
  (swiper-line-face :background user-current-state :foreground bg)
  (swiper-match-face-2 :background orange :foreground bg)
  (swiper-match-face-3 :background pink :foreground bg)
